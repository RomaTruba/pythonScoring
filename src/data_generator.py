...
class DataProcessor:
    ...
    def _preprocess_data(self, data):
        ...
        data['credit_class'] = np.where(risk_score < 0.3, 'Хороший', np.where(risk_score < 0.7, 'Средний', 'Плохой'))
